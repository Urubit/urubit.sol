...
contract URUBIT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 34 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Urubit";
    string private _symbol = "URUB";
    ...
    uint256 public _maxTxAmount = 34 * 10**6 * 10**8;
    uint256 public numTokensSellToAddToLiquidity = 3 * 10**6 * 10**8;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x7df43599A9c196430711317256C2E07ffB5b4150, 'We can not exclude Uniswap router.');
